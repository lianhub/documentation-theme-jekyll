---
title: Setting up EtherCAT master on PI-3
...
### 1. Choose linux: rpi-4.9.y

First download.

### 2. Choose RT preempt patch: patch-4.9.35-rt25.patch.gz

Ater installation, it change to :4.9.36-rt25-v7+?

## Prevent freezing

Follow these instructions modify cmdline.txt: [Freezing with RT-patch (Pi 3)](https://www.raspberrypi.org/forums/viewtopic.php?f=29&t=159170)
